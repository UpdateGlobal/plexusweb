...
<body class="home page page-id-5 page-template-default wpb-js-composer js-comp-ver-4.9.2 vc_responsive">
    <div class="header-socials-wrapper">
        <ul class="header-socials">
            <li><a class="header-social header-icon-facebook" href="blog.php#" title="Facebook"><i class="header-icons icon-facebook" ></i></a></li>
            <li><a class="header-social header-icon-twitter" href="blog.php#" title="Twitter"><i class="header-icons icon-twitter" ></i></a></li>
            <li><a class="header-social header-icon-basket" href="blog.php#" title="Shop"><i class="header-icons icon-basket" ></i><span>Shop</span></a></li>
        </ul>
        <div class="clear"></div>
    </div>
        ...
        <div id="container">
            ...
            <div class="post-view-wrapper">
                ...
                <div class="pego-columns-auto-height  pego-columns3 fl single-post-view isotope-item">
                    <a class="post-view-title-type" href="blog.php#">
                ...
                <div class="pego-columns-auto-height  pego-columns3 fl single-post-view isotope-item">
                    <a class="post-view-image-type" href="blog.php#">
