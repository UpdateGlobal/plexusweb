...
<body class="home page page-id-5 page-template-default wpb-js-composer js-comp-ver-4.9.2 vc_responsive">
    <div class="header-socials-wrapper">
        <ul class="header-socials">
            <li><a class="header-social header-icon-facebook" href="work.php#" title="Facebook"><i class="header-icons icon-facebook" ></i></a></li>
            <li><a class="header-social header-icon-twitter" href="work.php#" title="Twitter"><i class="header-icons icon-twitter" ></i></a></li>
            <li><a class="header-social header-icon-basket" href="work.php#" title="Shop"><i class="header-icons icon-basket" ></i><span>Shop</span></a></li>
        </ul>
        <div class="clear"></div>
    </div>
            ...
            <div class="menu-wrapper">
                <div class="menu-main-navigation-container">
                    <ul id="menu-main-navigation" class="sf-menu">
                        <li class="menu-item menu-item-has-children"><a href="index.php">Home</a>
                            <ul class="sub-menu">
                                <li class="menu-item"><a href="index.php">Home example #1</a></li>
                                <li class="menu-item"><a href="home-example-2.php">Home example #2</a></li>
                            </ul>
                        </li>
                        <li class="menu-item current-menu-item"><a href="work.php">Work</a></li>
            ...
            <div class="folio-view-wrapper">
                    ...
                    <div class="folio-view-item">
                        ...
                        <div class="folio-view-desc">
                            <div class="folio-view-categories">
                                <a href="work.php#" rel="tag">buildings</a>, <a href="work.php#" rel="tag">interior</a>, <a href="work.php#" rel="tag">pools</a> </div>
                ...
                <div class="pego-columns-auto-height  pego-columns6 fl folio-view isotope-item">
                    <div class="folio-view-item">
                        ...
                        <div class="folio-view-desc">
                            <div class="folio-view-categories">
                                <a href="work.php#" rel="tag">buildings</a>, <a href="work.php#" rel="tag">interior</a> </div>
                            <div class="folio-view-separator">/</div>
                            <div class="folio-view-date">March 25, 2015</div>
                            <div class="clear"></div>
                ...
                <div class="pego-columns-auto-height  pego-columns6 fl folio-view isotope-item">
                    <div class="folio-view-item">
                        ...
                        <div class="folio-view-desc">
                            <div class="folio-view-categories">
                                <a href="work.php#" rel="tag">interior</a>, <a href="work.php#" rel="tag">pools</a> </div>
                            <div class="folio-view-separator">/</div>
                            <div class="folio-view-date">March 25, 2015</div>
                            <div class="clear"></div>
                            <h1 class="single-folio-view-title"><a href="work.php#" >Renovated interior house for young family</a></h1>
                            <p class="folio-view-summary">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostr. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat.</p>
                        </div>
                ...
                <div class="pego-columns-auto-height  pego-columns6 fl folio-view isotope-item">
                    <div class="folio-view-item">
                        ...
                        <div class="folio-view-desc">
                            <div class="folio-view-categories">
                                <a href="work.php#" rel="tag">houses</a> </div>
                            <div class="folio-view-separator">/</div>
                            <div class="folio-view-date">March 25, 2015</div>
                            <div class="clear"></div>
                            <h1 class="single-folio-view-title"><a href="work.php#" >Modern and square house in London</a></h1>
                            <p class="folio-view-summary">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostr. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat.</p>
                        </div>
                ...
                <div class="pego-columns-auto-height  pego-columns6 fl folio-view isotope-item">
                    <div class="folio-view-item">
                        ...
                        <div class="folio-view-desc">
                            ...
                            <div class="clear"></div>
                            <h1 class="single-folio-view-title"><a href="work.php#" >Luxury house in Bali by Pego Design</a></h1>
                            <p class="folio-view-summary">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostr. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat.</p>
                        </div>
                ...
                <div class="pego-columns-auto-height  pego-columns6 fl folio-view isotope-item">
                    <div class="folio-view-item">
                        ...
                        <div class="folio-view-desc">
                            <div class="folio-view-categories">
                                <a href="work.php#" rel="tag">houses</a>, <a href="work.php#" rel="tag">pools</a> </div>
                            <div class="folio-view-separator">/</div>
                            <div class="folio-view-date">March 18, 2015</div>
                            <div class="clear"></div>
                            <h1 class="single-folio-view-title"><a href="work.php#" >Villa in Los Angeles architecture design</a></h1>
                            <p class="folio-view-summary">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostr. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat.</p>
                        </div>
